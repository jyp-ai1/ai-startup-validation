...
Updated: 2026-08-25 (session 6 — deep LIVE + Retry LIVE + Auth KI)
...
| `KNOWN_ISSUES.md` | Auth durable (KI-1) — CEO gate |
...
| 14 | Demo vs Auth | **LIVE Demo / Auth KI** | Demo LIVE; **Auth = Known Issue KI-1** |
