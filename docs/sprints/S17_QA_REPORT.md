...
**Production tip at QA close:** `72bb39409efa81e8d3a46de6dd37e43335e91fc1`  
...
| Gate | Result |
|------|--------|
| Production build-info | ✅ Served `72bb394` (S17 tip) after deploy catch-up from `671b26d` → `e3c4f59` → `72bb394` |
| Unit (S17 + workspace-state) | ✅ PASS — 3 files / 17 tests |
| Playwright `s17-internal-qa` (Production) | ✅ PASS — P0-1, P0-1b, P0-2/3/4, P0-5, P1-3 |
...
# QA open (pre-S17)
commit: 671b26d8f19ae3815bd52929a3829a30bf4ec2f4
deployTime: 2026-08-06T02:05:39.977Z

# S17 feature tip live
commit: e3c4f5941f665f82c18f1e7931f126199f52dcc8
deployTime: 2026-08-06T02:06:26.003Z

# S17 docs tip (QA close)
commit: 72bb39409efa81e8d3a46de6dd37e43335e91fc1
deployTime: 2026-08-06T02:08:47.868Z
branch: main
...
New Production-focused harness (does not replace S15 lag specs):
...
Internal QA **PASS** on Production `72bb394`.  
