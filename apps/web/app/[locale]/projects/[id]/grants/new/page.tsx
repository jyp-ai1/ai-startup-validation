...
export async function generateMetadata({
  ...
  return {
    title: project
      ? `New Grant | ${project.title} | AI Startup Validation Framework`
      : 'New Grant | AI Startup Validation Framework',
  };
}
...
export default async function NewGrantPage({ params }: NewGrantPageProps) {
  ...
  return (
    <>
      <PageHeader title="New Grant Program" description={project.title} />
      <div className="mt-4">
