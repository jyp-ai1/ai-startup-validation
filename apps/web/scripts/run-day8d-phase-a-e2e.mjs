#!/usr/bin/env node
/**
 * Run DAY 8-D Phase A Dynamic Judgment E2E (J1–J2).
 */
...
function findFreePort(start = 3298) {
...
console.info('[day8d-phase-a] Building production bundle for E2E…');
...
const result = spawnSync(
  ...
  [
    ...
    'e2e/day8d-phase-a-judgment.spec.ts',
    '--retries=0',
  ],
