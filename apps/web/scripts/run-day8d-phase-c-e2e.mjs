#!/usr/bin/env node
/**
 * Run DAY 8-D Phase C No-Ask E2E (C1–C6).
 */
...
function findFreePort(start = 3300) {
...
console.info('[day8d-phase-c] Building production bundle for E2E…');
...
const result = spawnSync(
  ...
  [
    ...
    'e2e/day8d-phase-c-no-ask.spec.ts',
    '--retries=0',
  ],
