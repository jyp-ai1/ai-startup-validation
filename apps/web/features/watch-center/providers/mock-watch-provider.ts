    ...
    for (const item of watchlist) {
      if (item.watchType === 'MARKET') {
        signals.push({
          ...
          watchType: 'MARKET',
          label: item.label,
          titleKey: 'watch.signals.marketUpdate.title',
          summaryKey: 'watch.signals.marketUpdate.summary',
          priority: 'INFO',
          category: 'MARKET',
      ...
      if (item.watchType === 'COMPETITOR') {
        signals.push({
          ...
          label: item.label,
          titleKey: 'watch.signals.competitorUpdate.title',
          summaryKey: 'watch.signals.competitorUpdate.summary',
          priority: 'WARNING',
          category: 'COMPETITOR',
      ...
      if (item.watchType === 'GOVERNMENT') {
        signals.push({
          ...
          label: item.label,
          titleKey: 'watch.signals.governmentUpdate.title',
          summaryKey: 'watch.signals.governmentUpdate.summary',
          priority: 'CRITICAL',
          category: 'GOVERNMENT',
      ...
      signals.push(
        {
          ...
          watchType: 'MARKET',
          label: 'Healthcare AI',
          titleKey: 'watch.signals.marketGrowth.title',
          summaryKey: 'watch.signals.marketGrowth.summary',
          priority: 'INFO',
          category: 'MARKET',
          href: `/projects/${projectId}/market`,
        },
        {
          ...
          watchType: 'COMPETITOR',
          label: 'OpenAI',
          titleKey: 'watch.signals.competitorLaunch.title',
          summaryKey: 'watch.signals.competitorLaunch.summary',
          priority: 'WARNING',
          category: 'COMPETITOR',
          href: `/projects/${projectId}/competitors`,
        },
        {
          ...
          watchType: 'GOVERNMENT',
          label: 'TIPS',
          titleKey: 'watch.signals.governmentDeadline.title',
          summaryKey: 'watch.signals.governmentDeadline.summary',
          priority: 'CRITICAL',
          category: 'GOVERNMENT',
          href: `/projects/${projectId}/government`,
        },
