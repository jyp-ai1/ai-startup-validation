...
import { Button, Card, CardContent, CardHeader, CardTitle, PageHeader, Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@repo/ui';
  ...
  return (
    <div className="space-y-12 pb-16">
        ...
        <div className="flex flex-wrap items-start justify-between gap-6">
          <div>
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              {t('providerNote', { provider: decision.providerId.toUpperCase() })}
            </p>
          </div>
      ...
      <section className="space-y-4">
        <h2 className="text-lg font-semibold tracking-tight">{t('scoresTitle')}</h2>
        <DecisionScoreGrid scores={decision.scores} />
      </section>

      {/* Executive Summary */}
      <section className="ll-consulting-card space-y-4 px-8 py-8">
        ...
        <ul className="space-y-3">
          {decision.reasons.map((reason) => (
            ...
            >
              ...
              <span>
                {t(reason.textKey as 'reasons.hold.voc', reason.params ?? {})}
              </span>
            </li>
          ))}
        </ul>
            ...
            <Card key={opp.id}>
              ...
              <CardContent>
                ...
                <p className="mt-2 text-xs uppercase tracking-wider text-muted-foreground">
                  {t(`opportunityCategory.${opp.category.toLowerCase()}` as 'opportunityCategory.market')}
                </p>
              </CardContent>
            </Card>
          ))}
